...
const Footer = () => {
    ...
    <div className="footer-container">
        <footer className="footer">
            ...
            <a href="https://www.facebook.com/mybassistchris/" target="_blank" rel="noopener noreferrer" className="fa fa-facebook"></a>
            <a href="https://twitter.com/mybassistchris" target="_blank" rel="noopener noreferrer"  className="fa fa-twitter"></a>
        </footer>
    </div>
    )
}
